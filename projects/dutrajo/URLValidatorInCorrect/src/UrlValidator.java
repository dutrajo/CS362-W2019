...
public class UrlValidator implements Serializable {
    ...
    //FOUND BUG: PATH_REGEX = "^(/[-\\w:@&?=+,.!*'%$_;\\(\\)]*)?$";
	//BUG FIX: change to PATH_REGEX = "^(/[-\\w:@&?=+,.!/~*'%$_;\\(\\)]*)?$";
   ...
   private static final String[] DEFAULT_SCHEMES = {"http", "https", "ftp"}; // Must be lower-case
    ...
    public boolean isValid(String value) {
        ...
        //Found Bug: "http".equals(scheme) 
		//Bug Fix: change to "file".equals(scheme)
    ...
    protected boolean isValidAuthority(String authority) {
        ...
        if (ipv6 != null) {
            InetAddressValidator inetAddressValidator = InetAddressValidator.getInstance();
                ...
                //FOUND BUG: ADDED THE FOLLOWING BLOCK (DIDN'T EXIST BEFORE)
                //REASON: IPv6 port values weren't being checked for validity
