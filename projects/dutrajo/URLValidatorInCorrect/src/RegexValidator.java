...
public class RegexValidator implements Serializable {
    ...
    public RegexValidator(String[] regexs, boolean caseSensitive) {
    	//FOUND BUG: regexs != null
		//BUG FIX: change to regexs == null
        ...
        //FOUND BUG: (int i = 0; i < regexs.length-1; i++) (specifically the -1 part)
		//BUG FIX: change to (int i = 0; i < regexs.length; i++)
